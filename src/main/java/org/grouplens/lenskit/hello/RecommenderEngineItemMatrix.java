 ...
 */
public class RecommenderEngineItemMatrix extends RecommenderEngine {
    private EventDAO dao;
    public RecommenderEngineItemMatrix(EventDAO dao)
    {
        this.dao = dao;
    }
    @Override
    public LenskitRecommenderEngine getRecommender() {
        ...
        try {
            ...
            LenskitConfiguration config2 = ConfigHelpers.load(new File("etc/matrix-factorization.groovy"));

 ...
 */
public class RecommenderEngineUserItem extends RecommenderEngine {
    private EventDAO dao;
    public RecommenderEngineUserItem (EventDAO dao)
    {
        this.dao = dao;
    }
    @Override
    public LenskitRecommenderEngine getRecommender() {
        ...
        try {
            ...
            LenskitConfiguration config2 = ConfigHelpers.load(new File("etc/user-user-collaborative.groovy"));
